...
# Historical Phase 4.4-P0 evidence used this exact, narrower grammar. Keep it
# local so later runtime denominator changes cannot retrospectively alter the
# accepted report or its focused tests.
