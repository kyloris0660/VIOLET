...
- Partial staging cleanup dry-run result: target safe label `phase_3_8d_partial_staging`, exists, dedicated Phase 3.8d target, `97` files, `340,159,586` bytes, extension distribution `.jpg=68`, `.png=22`, `.jpeg=6`, `.gif=1`, no protected-root overlap, no deletion performed.
