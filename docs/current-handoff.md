...
- 36号验收交付核对：PR152仍OPEN/CLEAN，未关闭线程现为14；新增3条P2涉及互补donor、恢复并发及复制子进程退出，已只读核对并保留原文，未扩展本次按钮验收执行范围，待负责人裁决。
...
下一检查点：36号原R6修正及普通EXE真实UIA停止/启动/重启验收已完成，原525/147与生产保护证据保留；返回负责人复审更新私有包与同一PR152，并裁决新增3条P2意见。实际接受并合并后按原授权对齐main/profile/持久入口，不自行合并或启动A2。
