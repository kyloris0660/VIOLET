...
- Partial staging cleanup dry-run confirms the dedicated target safe label `phase_3_8d_partial_staging`: `97` files, `340,159,586` bytes, extension distribution `.jpg=68`, `.png=22`, `.jpeg=6`, `.gif=1`, no source/iCloud/repo/app-storage overlap, and no deletion performed.
