...
- `manual_sync_execute_forced_force_suggestions_true_for_all_ai_tags`.
- Why missed: previous gates counted ai_tagged media and proper-noun suggestion safety, but did not assert assignment-level normal-vs-suggestion semantics for high-confidence non-proper tags.

## Repair

- Status: `repaired`.
- Before: `{'all_ai_assignments_are_suggestions': True, 'high_conf_nonproper_expected_normal_count': 12973, 'high_conf_nonproper_incorrect_suggestion_count': 12973, 'proper_noun_non_suggestion_count': 0, 'classification_unknown_or_empty_rate_percent': 6.59}`.
- Repair results: `{'assignments_converted_from_suggestion_to_normal': 12973, 'assignments_converted_from_normal_to_suggestion': 0, 'assignments_kept_suggestion': 4491, 'assignments_kept_normal': 0, 'assignments_deleted_or_replaced': 0, 'duplicate_rows_created': 0, 'classification_rechecked': True, 'classification_items_rechecked': 349, 'classification_items_changed': 0}`.
- After: `{'all_ai_assignments_are_suggestions': False, 'high_conf_nonproper_expected_normal_count': 12973, 'high_conf_nonproper_incorrect_suggestion_count': 0, 'high_conf_nonproper_normal_count': 12973, 'proper_noun_non_suggestion_count': 0, 'proper_noun_suggestion_count': 207, 'classification_content_class_counts': {'anime': 314, 'non_anime': 12, 'unknown': 23}, 'classification_unknown_or_empty_rate_percent': 6.59}`.
- UI verification: `{'status': 'passed', 'method': 'in_app_browser_playwright_against_launcher_started_production_server_with_tag_state_polling', 'computer_use_attempted': True, 'computer_use_result': 'unavailable_in_current_tool_session; tool discovery exposed browser/node automation but not computer-use controls', 'sample_count': 8, 'normal_visible_pass_count': 8, 'proper_suggestion_visible_pass_count': 8, 'any_suggestion_visible_pass_count': 8, 'samples_expect_proper_suggestions': 3, 'screenshot_count': 3, 'raw_artifact': '.local_manifests/s3a_m2_delta_e2e/incident/ui-validation-private.json', 'raw_screenshots_committed': False, 'raw_ids_private': True, 'public_safe': True}`.
